...
router.route('/FilterPhones').post(keyVerify, loginVerify, controller.FilterPhones)
...
router.route('/imageWait').post(keyVerify, loginVerify, upload, controller.ImageWait)
